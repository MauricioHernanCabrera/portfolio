<template lang="pug">
  div
    nav.p-3
      ul.social-media
        li(v-for="item in socialMedia" :key="item._id")
  ...
  data() {
    return {
      socialMedia: [
        ...
        {
          _id: "linkedin",
          href: "https://www.linkedin.com/in/mauriciohernancabrera",
          path:
        ...
        {
          _id: "email",
          href: "mailto:mauriciohernancabrera@gmail.com",
          path:
        ...
        {
          _id: "wa",
          href: "https://wa.me/5493794883889",
          path:
